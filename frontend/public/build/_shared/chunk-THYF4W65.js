...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React20.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay2 = React21.forwardRef(_c = ({
  className,
  ...props
...
var DialogContent2 = React21.forwardRef(_c3 = ({
  className,
  children,
  showClose = true,
  ...props
  ...
  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Content, { ref, className: cn("fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg", className), ...props, children: [
    children,
    showClose && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground", children: [
...
var DialogTitle2 = React21.forwardRef(_c7 = ({
  className,
  ...props
...
var DialogDescription2 = React21.forwardRef(_c9 = ({
  className,
  ...props
...
var Input = React24.forwardRef(_c10 = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("input", { type, className: cn("flex h-9 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm text-foreground shadow-sm shadow-black/5 transition-shadow placeholder:text-muted-foreground/70 focus-visible:border-ring focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/20 disabled:cursor-not-allowed disabled:opacity-50", "[&:user-invalid]:border-red-500/50", "[&:user-invalid]:focus-visible:border-red-500", type === "search" && "[&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:appearance-none [&::-webkit-search-results-button]:appearance-none [&::-webkit-search-results-decoration]:appearance-none", type === "file" && "p-0 pr-3 italic text-muted-foreground/70 file:me-3 file:h-full file:border-0 file:border-r file:border-solid file:border-input file:bg-transparent file:px-3 file:text-sm file:font-medium file:not-italic file:text-foreground", className), ref, ...props }, void 0, false, {
...
var TextArea = React24.forwardRef(_c32 = ({
  className,
  ...props
}, ref) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("textarea", { className: cn("flex w-full rounded-lg border border-input bg-background px-3 py-2 text-sm text-foreground shadow-sm shadow-black/5 transition-shadow placeholder:text-muted-foreground/70 focus-visible:border-ring focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/20 disabled:cursor-not-allowed disabled:opacity-50", "[&:user-invalid]:border-red-500/50", "[&:user-invalid]:focus-visible:border-red-500", className), ref, ...props }, void 0, false, {
    fileName: "app/components/ui/input.tsx",
    lineNumber: 36,
    columnNumber: 10
  }, this);
...
var _c32;
var _c42;
$RefreshReg$(_c10, "Input$React.forwardRef");
$RefreshReg$(_c22, "Input");
$RefreshReg$(_c32, "TextArea$React.forwardRef");
$RefreshReg$(_c42, "TextArea");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
var Label = React25.forwardRef(_c11 = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("label", { ref, className: cn("text-sm font-medium leading-4 text-foreground peer-disabled:cursor-not-allowed peer-disabled:opacity-70", className), ...props }, void 0, false, {
...
var _c11;
var _c23;
$RefreshReg$(_c11, "Label$React.forwardRef");
