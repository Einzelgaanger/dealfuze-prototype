...
import { SelectComponent } from "@deal-fuze/server";
import {
  BaseEditor,
  DefaultElements,
...
export function SelectEditor({
...
}: OptionsComponentEditorProps<SelectComponent>) {
  ...
  const [currentComponent, setCurrentComponent] = useState<{
    ...
    component: {
      ...
      data: {
        ...
        // @ts-ignore
        values: [
          ...(component.data as { values: { label: string; value: string }[] })
            .values,
        ],
      },
    } as SelectComponent,
  ...
  const addOption = () => {
    const values = (
      currentComponent.component.data as {
    ...
    setCurrentComponent({
      ...
      component: {
        ...
        data: {
          ...currentComponent.component.data,
          // @ts-ignore
          values: [...values, { label: "New Option", value: "new_option" }],
        },
      },
    });
      ...
      <div>
        ...
        {currentTab === "data" && (
          <div>
            ...
            <ScrollArea
              ref={optionsRef}
              className="overflow-y-scroll max-h-[40vh] bg-background pb-8"
            >
              {(
                currentComponent.component.data as {
                  values: { label: string; value: string }[];
