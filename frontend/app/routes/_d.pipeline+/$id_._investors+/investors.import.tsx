...
export async function loader(args: LoaderFunctionArgs) {
  ...
  const investorSubmissions = await api.get<SubmissionDocument[]>(
...
export default function InvestorsImport() {
  const { investorForm, matchCriteria } = useLoaderData<{
  ...
  return (
    <ImportDialog
      formId={investorForm._id as string}
      isOpen={true}
      onClose={() => navigate("/pipeline/" + id + "/investors")}
      formComponents={investorForm.components}
